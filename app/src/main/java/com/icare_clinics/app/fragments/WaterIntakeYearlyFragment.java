...
public class WaterIntakeYearlyFragment extends Fragment {
    ...
    private String SelectedDate,tempDate;

    public WaterIntakeYearlyFragment(Context context, int i,Calendar startCal) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(dataSelection==2)
        {
            ...
            startCalender.set(startCalender.get(Calendar.YEAR),0,1,00,00,00);
            getStartAndEndTimes();
    ...
    private void getStartAndEndTimes() {
        ...
        int numOfDaysInMonth = startCalender.getActualMaximum(Calendar.DAY_OF_YEAR);
...
//        data.setValueFormatter(new LargeValueFormatter());
    ...
    {
        if(dataSelection ==2 ) //tabsType.Year
        {
            if(isDecrement) {
    ...
    private void setDateForPref() {
        tempCal.set(startCalender.get(Calendar.YEAR),tempCal.get(Calendar.MONTH),tempCal.get(Calendar.DAY_OF_MONTH),00,00,00);
    ...
    private void setCalenderForDecrement() {
        ...
        startCalender.set(startCalender.get(Calendar.YEAR),0,1,00,00,00);
        endCalender.set(startCalender.get(Calendar.YEAR),11, 31,23,59,59);
    }
    private void setCalenderForIncrement() {
        startCalender= (Calendar) endCalender.clone();
        endCalender.add(Calendar.YEAR, 1);

        startCalender.set(endCalender.get(Calendar.YEAR),0,1,00,00,00);
        endCalender.set(startCalender.get(Calendar.YEAR),11, 31,23,59,59);
    }
