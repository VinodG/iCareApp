...
public class InsuranceCoveredFragment extends Fragment {
    private RecyclerView rvInsuranceCover;
    private TextView tvNotFound;
    private ArrayList<InsuranceDo> arrCoverInsu;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        arrCoverInsu = (ArrayList)insuCoverBundle.getSerializable("coveredInsurance");
        if(arrCoverInsu != null && arrCoverInsu.size() >0) {
            rvInsuranceCover.setVisibility(View.VISIBLE);
            tvNotFound.setVisibility(View.GONE);
            mAdapter=new InsuranceAdapter(context,arrCoverInsu);
