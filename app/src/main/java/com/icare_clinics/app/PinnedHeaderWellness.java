...
public class PinnedHeaderWellness extends ExpandableListView {
    ...
    private WellnessPackagesFragmentNew.WellnessAdapter mAdapter;
    ...
    public PinnedHeaderWellness(Context context) {
        super(context);
    }

    public PinnedHeaderWellness(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PinnedHeaderWellness(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        mAdapter = (WellnessPackagesFragmentNew.WellnessAdapter) adapter;
    }
