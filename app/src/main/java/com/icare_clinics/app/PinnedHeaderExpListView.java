...
/**
 * Created by Sreekanth.P on 18-08-2017.
 */
...
public class PinnedHeaderExpListView extends ExpandableListView {
    ...
    private SearchActivityNew.MyExpandableListAdapterNew mAdapter;
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        super.setAdapter(adapter);
            mAdapter = (SearchActivityNew.MyExpandableListAdapterNew) adapter;
    }
