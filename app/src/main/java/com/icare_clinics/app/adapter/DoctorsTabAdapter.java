...
public class DoctorsTabAdapter extends RecyclerView.Adapter<DoctorsTabAdapter.MyViewHolder> {

    //    public ArrayList<Drawable>allImagesId = new ArrayList<Drawable>();
...
*/
    ...
    public DoctorsTabAdapter(Context context, ArrayList<DoctorDo> arrDoctor) {
...
//        holder.tvDegee.setText(specializationDO.name);
...
//            ((BaseActivity) context).setImageCircle(imageurl, holder.ivDoctor, R.drawable.docto1);
            ((BaseActivity)context).setDoctorsImage(imageurl,holder.ivDoctor);
        } else {
            //image not found
        }
